...
constexpr auto CLASS_UNLOCK_BIT_FIELD_SIZE = 8;
using ClassUnlockBitset = std::bitset<CLASS_UNLOCK_BIT_FIELD_SIZE * 8>;
using ClassUnlockData = std::array<uint8_t, CLASS_UNLOCK_BIT_FIELD_SIZE>;
...
static const auto CLASS_NAME_LIST = std::list<std::string>{
    "Noble",
    "Commoner",
    "Myrmidon",
    "Soldier",
...
static const auto UNIT_ID_NAME_MAP = std::unordered_map<CharacterId, std::string>{
    ...
    {86, "Gilbert"},
    {99, "Edelgard"},
    {100, "Imperial Soldier"},
    {101, "Kingdom Soldier"},
    {102, "Alliance Soldier"},
    {103, "Flame Emperor Soldier"},
    {104, "Agarthan Soldier"},
    {105, "Agarthan Soldier"},
    {106, "Church Soldier"},
    {107, "Western Church Soldier"},
    {108, "Vice Bishop"},
    {109, "Bishop"},
    {110, "Student"},
    {111, "Villager"},
    ...
    {113, "Rogue"},
    {114, "Bandit"},
    {115, "Mysterious Soldier"},
    {116, "Ancient Soldier"},
    {117, "Mysterious Mage"},
    {118, "Gaspard Soldier"},
    {119, "Gaspard Commander"},
    {120, "Charon"},
    {121, "Goneril"},
    {122, "Daphnel"},
    {123, "Gautier"},
    ...
    {142, "Phantom General"},
    {143, "Magic Wielder"},
    {144, "Alliance General"},
    {145, "Alliance Soldier"},
    {146, "Duscur General"},
    {147, "Goneril Soldier"},
    {148, "Almyran General"},
    {149, "Bandit Leader"},
    ...
    {153, "Odesse"},
    {154, "Baron Dominic "},
    {155, "Rampaging Villager"},
    {156, "Rampaging Cardinal"},
    {157, "Frenzied Church Leader"},
    {158, "Frenzied Church Soldier"},
    {159, "Pirate Captain"},
    {160, "King of Beasts"},
    {161, "King of Fangs"},
    {162, "King of Wings"},
    ...
    {200, "Black Beast"},
    {201, "Wandering Beast"},
    {202, "Wild Demonic Beast"},
    {203, "Demonic Beast"},
    {204, "Demonic Beast"},
    {205, "Demonic Beast"},
    {206, "Giant Demonic Beast"},
    {207, "Winged Demonic Beast"},
    {208, "Golem"},
    {209, "Golem"},
    {210, "Titanus"},
    {211, "White Beast"},
    {212, "The Immaculate One"},
    ...
    {225, "Chevalier"},
    {226, "Wilhelm"},
    {227, "Stone Demonic Beast"},
    {228, "Umbral Beast"},
    {229, "Golem"},
    {230, "Forlorn Beast"},
    {231, "Marcelle"},
    {232, "Simone"},
    {260, "Imperial General"},
    {261, "Imperial General"},
    {262, "Imperial General"},
    {263, "Imperial General"},
    {264, "Imperial General"},
    {265, "Imperial General"},
    {266, "Imperial General"},
    {267, "Kingdom General"},
    {268, "Kingdom General"},
    {269, "Kingdom General"},
    {270, "Kingdom General"},
    ...
    {272, "Kingdom General"},
    {273, "Kingdom General"},
    {274, "Alliance General"},
    {275, "Alliance General"},
    {276, "Alliance General"},
    {277, "Alliance General"},
    {278, "Alliance General"},
    {279, "Alliance General"},
    {280, "Alliance General"},
    {281, "Knight of Seiros"},
    {282, "Knight of Seiros"},
    {283, "Knight of Seiros"},
    {284, "Knight of Seiros"},
    {285, "Kingdom General"},
    {286, "Knight of Seiros"},
    {287, "Knight of Seiros"},
    {288, "Knight of Seiros"},
    {289, "Knight of Seiros"},
    {300, "Fishkeeper"},
    {301, "Greenhouse Keeper"},
    {302, "Head Chef"},
    {304, "Saint Statue Artisan"},
    {305, "Battalion Guildmaster"},
    {306, "Counselor"},
    {307, "Dining Hall Staff"},
    {308, "Stable Hand"},
    {309, "Choir Coordinator"},
    {310, "Tournament Organizer"},
    {311, "Trader"},
    {312, "Certification Proctor"},
    {313, "Southern Merchant"},
    {314, "Eastern Merchant"},
    {315, "Dark Merchant"},
    {316, "Armorer"},
    {317, "Blacksmith"},
    {318, "Online Liaison"},
    ...
    {390, "War Master"},
    {391, "Gremory"},
    {392, "Secret Shopkeeper"},
    {393, "Sauna Boss"},
    {394, "Wayseer"},
    {395, "Mysterious Teacher"},
    {396, "Influencer"},
    {400, "Thief"},
    {401, "Thief"},
    {402, "Militia"},
    {403, "Militia"},
    {404, "Militia"},
    {405, "Gaspard Commander"},
    {406, "Mysterious Mage"},
    {407, "Western Church Soldier"},
    {408, "Knight of Seiros"},
    {409, "Rogue"},
    {410, "Rogue"},
    {411, "Flame Emperor Soldier"},
    {412, "Villager"},
    {413, "Rampaging Villager"},
    {414, "Student"},
    {415, "Student"},
    {416, "Student"},
    {417, "Student"},
    {418, "Knight of Seiros"},
    {419, "Knight of Seiros"},
    {420, "Imperial Soldier"},
    {421, "Imperial Soldier"},
    {422, "Imperial Soldier"},
    {423, "Imperial Soldier"},
    {424, "Alliance General"},
    {425, "Imperial General"},
    {426, "Imperial Soldier"},
    {427, "Alliance Soldier"},
    {428, "Imperial Soldier"},
    {429, "Imperial Soldier"},
    {430, "Imperial Soldier"},
    {431, "Thief"},
    {432, "Agarthan Soldier"},
    {433, "Mysterious Soldier"},
    {434, "Knight of Seiros"},
    {435, "Imperial Soldier"},
    {436, "Alliance General"},
    {437, "Villager"},
    {438, "Knight of Seiros"},
    {439, "Knight of Seiros"},
    {440, "Kingdom General"},
    {441, "Kingdom Soldier"},
    {442, "Kingdom General"},
    {443, "Knight of Seiros"},
    {444, "Imperial General"},
    {445, "Imperial General"},
    {446, "Almyran Soldier"},
    {447, "Thief"},
    {448, "Thief Leader"},
    {449, "Thief"},
    ...
    {472, "Thief"},
    {473, "Thief Leader"},
    {474, "Imperial Soldier"},
    {475, "Kingdom Soldier"},
    {476, "Rogue"},
    {477, "Merchant"},
    {478, "Imperial Soldier"},
    {479, "Mysterious Mage"},
    {480, "Mysterious Mage"},
    {481, "Villager"},
    {482, "Villager"},
    ...
    {492, "Rogue"},
    {493, "Rogue"},
    {494, "Knight of Seiros"},
    {495, "Knight of Seiros"},
    {496, "Merchant"},
    {497, "Merchant"},
    {498, "Merchant"},
    {499, "Alliance General"},
    {500, "Crest Scholar"},
    {501, "Crest Scholar"},
    {502, "Goneril Soldier"},
    {503, "Goneril Soldier"},
    ...
    {546, "Priest"},
    {547, "Student"},
    {548, "Rampaging Villager"},
    {549, "Rampaging Villager"},
    {550, "Village Child"},
    {551, "Villager"},
    {552, "Knight of Seiros"},
    {553, "Kingdom Soldier"},
    {554, "Knight of Seiros"},
    {555, "Mercenary"},
    {556, "Mercenary"},
    {557, "Kingdom General"},
    {558, "Kingdom Soldier"},
    {559, "Duke Aegir"},
    {560, "Imperial Soldier"},
    {561, "Knight of Seiros"},
    {562, "Knight of Seiros"},
    {563, "Knight of Seiros"},
    {564, "Knight of Seiros"},
    {565, "Nardel"},
    {566, "Knight of Seiros"},
    {567, "Knight of Seiros"},
    {568, "Church Soldier"},
    {569, "Knight of Seiros"},
    {570, "Knight of Seiros"},
    {571, "Church Soldier"},
    {572, "Kingdom Soldier"},
    {573, "Knight of Seiros"},
    {574, "Kingdom General"},
    {575, "Kingdom Soldier"},
    {576, "Knight of Seiros"},
    {577, "Knight of Seiros"},
    {578, "Knight of Seiros"},
    {579, "Church Soldier"},
    {580, "Church Soldier"},
    {581, "Knight of Seiros"},
    {582, "Church Soldier"},
    {583, "Knight of Seiros"},
    {584, "Dukedom General"},
    {585, "Kingdom Soldier"},
    {586, "Alliance Soldier"},
    {587, "Alliance Soldier"},
    {588, "Alliance Soldier"},
    {589, "Imperial Soldier"},
    {590, "Kingdom Soldier"},
    {591, "Kingdom Soldier"},
    {592, "Prisoner"},
    {593, "Kingdom General"},
    {594, "Imperial General"},
    {595, "Imperial Soldier"},
    {596, "Church Soldier"},
    {597, "Imperial Soldier"},
    {598, "Church Soldier"},
    {599, "Imperial Soldier"},
    {600, "Wild Demonic Beast"},
    {601, "Knight of Seiros"},
    {602, "Knight of Seiros"},
    {603, "Knight of Seiros"},
    {604, "Imperial General"},
    {605, "Traveler"},
    {606, "Knight"},
    {607, "Ruffian"},
    {608, "Town Girl"},
    ...
    {646, "Maiden"},
    {647, "Gatekeeper"},
    {648, "Imperial Soldier"},
    {649, "Knight of Seiros"},
    {650, "Knight of Seiros"},
    {651, "Knight of Seiros"},
    {652, "Priest"},
    {653, "Knight of Seiros"},
    {654, "Monk"},
    {655, "Monk"},
    {656, "Squire"},
    {657, "Imperial Soldier"},
    {662, "Mysterious Mage"},
    {663, "Thief"},
    {664, "Thief"},
    {666, "Imperial Soldier"},
    {667, "Imperial Soldier"},
    {668, "Knight of Seiros"},
    {669, "Knight of Seiros"},
    {670, "Knight of Seiros"},
    {671, "Knight of Seiros"},
    {672, "Knight of Seiros"},
    {673, "Student"},
    {674, "Student"},
    {675, "Student"},
    {676, "Student"},
    ...
    {678, "Student"},
    {679, "Sothis"},
    {680, "Imperial Soldier"},
    {681, "Rhea"},
    {682, "Mercenary"},
    {683, "Rogue"},
    {684, "Imperial Soldier"},
    {685, "Imperial Soldier"},
    {686, "Agarthan Soldier"},
    {687, "Shifty Merchant"},
    {688, "Monk"},
    {689, "Student"},
    {690, "Student"},
    ...
    {709, "Kingdom Noble"},
    {710, "Kingdom Noble"},
    {711, "Kingdom Commoner"},
    {712, "Kingdom Commoner"},
    {713, "Empire Noble"},
    {714, "Empire Commoner"},
    {715, "Kingdom Noble"},
    {716, "Kingdom Commoner"},
    {717, "Monk"},
    {718, "Monk"},
    {719, "Knight of Seiros"},
    {720, "Knight of Seiros"},
    {721, "Mercenary"},
    {722, "Mercenary"},
    {723, "Scholar"},
    {724, "Scholar"},
    ...
    {742, "Kingdom Noble"},
    {743, "Kingdom Noble"},
    {744, "Kingdom Commoner"},
    {745, "Kingdom Commoner"},
    {746, "Empire Noble"},
    {747, "Empire Commoner"},
    {748, "Kingdom Noble"},
    {749, "Kingdom Commoner"},
    {750, "Monk"},
    {751, "Monk"},
    {752, "Knight of Seiros"},
    {753, "Knight of Seiros"},
    {754, "Mercenary"},
    {755, "Mercenary"},
    {756, "Scholar"},
    {757, "Scholar"},
    ...
    {764, "Student"},
    {765, "Student"},
    {766, "Knight of Seiros"},
    {767, "Knight of Seiros"},
    {768, "Knight of Seiros"},
    {774, "Knight of Seiros"},
    {775, "Knight of Seiros"},
    {778, "Student"},
    {779, "Knight of Seiros"},
    {780, "Monk"},
    {781, "Soldier"},
    {782, "Soldier"},
    {783, "Knight of Seiros"},
    {784, "Soldier"},
    {785, "Monk"},
    {786, "Soldier"},
    {787, "Soldier"},
    {788, "Soldier"},
    {789, "Soldier"},
    {790, "Knight of Seiros"},
    {791, "Student"},
    {792, "Knight of Seiros"},
    {793, "Student"},
    {794, "Monk"},
    {795, "Artisan"},
    {796, "Artisan"},
    ...
    {800, "Soldier"},
    {801, "Soldier"},
    {802, "Knight of Seiros"},
    {803, "Knight of Seiros"},
    {804, "Knight of Seiros"},
    {805, "Monk"},
    {806, "Soldier"},
    {807, "Soldier"},
    {808, "Knight of Seiros"},
    {809, "Merchant"},
    {810, "Churchgoer"},
    {811, "Churchgoer"},
    {812, "Monk"},
    {813, "Merchant"},
    {814, "Knight of Seiros"},
    {815, "Monk"},
    {816, "Monk"},
    {817, "Priest"},
    {818, "Soldier"},
    ...
    {820, "Soldier"},
    {821, "Alliance Knight"},
    {822, "Knight of Seiros"},
    {823, "Merchant"},
    {824, "Alliance Knight"},
    {825, "Merchant"},
    {826, "Kingdom Knight"},
    {827, "Knight of Seiros"},
    {828, "Student"},
    {829, "Knight of Seiros"},
    {830, "Student"},
    {831, "Student"},
    {832, "Student"},
    {833, "Soldier"},
    {834, "Soldier"},
    {835, "Knight of Seiros"},
    {836, "Kingdom Knight"},
    {837, "Knight of Seiros"},
    {838, "Soldier"},
    {839, "Merchant"},
    {840, "Churchgoer"},
    {841, "Alliance Knight"},
    {842, "Knight of Seiros"},
    {843, "Monk"},
    {844, "Monk"},
    {845, "Knight of Seiros"},
    {846, "Soldier"},
    {847, "Merchant"},
    {848, "Merchant"},
    {849, "Priest"},
    {850, "Merchant"},
    {851, "Knight of Seiros"},
    {852, "Kingdom Knight"},
    {853, "Churchgoer"},
    {854, "Monk"},
    {855, "Monk"},
    {856, "Knight of Seiros"},
    {857, "Monk"},
    {858, "Knight of Seiros"},
    {859, "Student"},
    {860, "Soldier"},
    {861, "Soldier"},
    {862, "Knight of Seiros"},
    {863, "Soldier"},
    {864, "Knight of Seiros"},
    {865, "Merchant"},
    {866, "Monk"},
    {867, "Soldier"},
    {868, "Merchant"},
    {869, "Student"},
    {870, "Knight of Seiros"},
    {871, "Priest"},
    {872, "Monk"},
    {873, "Monk"},
    {874, "Citizen"},
    ...
    {888, "Soldier"},
    {889, "Merchant"},
    {890, "Knight of Seiros"},
    {891, "Kingdom Knight"},
    {892, "Priest"},
    {893, "Knight of Seiros"},
    {894, "Soldier"},
    {895, "Student"},
    {896, "Student"},
    {897, "Knight of Seiros"},
    {898, "Girl"},
    {899, "Soldier"},
    {900, "Soldier"},
    {901, "Soldier"},
    ...
    {912, "Soldier"},
    {913, "Student"},
    {914, "Knight of Seiros"},
    {915, "Monk"},
    {916, "Knight of Seiros"},
    {917, "Knight of Seiros"},
    {918, "Soldier"},
    {919, "Soldier"},
    {920, "Knight of Seiros"},
    {921, "Knight of Seiros"},
    {922, "Soldier"},
    {923, "Monk"},
    {924, "Soldier"},
    {925, "Merchant"},
    {926, "Knight of Seiros"},
    {927, "Merchant"},
    {928, "Priest"},
    {929, "Merchant"},
    {930, "Merchant"},
    {931, "Monk"},
    {932, "Knight of Seiros"},
    {933, "Squire"},
    {934, "Knight of Seiros"},
    {935, "Soldier"},
    {936, "Soldier"},
    {937, "Soldier"},
    {938, "Knight of Seiros"},
    {939, "Knight of Seiros"},
    {940, "Knight of Seiros"},
    {941, "Soldier"},
    {942, "Priest"},
    {943, "Knight of Seiros"},
    {944, "Churchgoer"},
    {945, "Churchgoer"},
    {946, "Squire"},
    {947, "Monk"},
    ...
    {957, "Soldier"},
    {958, "Soldier"},
    {959, "Knight of Seiros"},
    {960, "Knight of Seiros"},
    {961, "Soldier"},
    {962, "Scholar"},
    {963, "Scholar"},
    {964, "Scholar"},
    ...
    {975, "Citizen"},
    {976, "Citizen"},
    {977, "Knight of Seiros"},
    {978, "Soldier"},
    {979, "Knight of Seiros"},
    {980, "Knight of Seiros"},
    {981, "Knight of Seiros"},
    {982, "Knight of Seiros"},
    {983, "Priest"},
    {984, "Knight of Seiros"},
    {985, "Citizen"},
    {986, "Knight of Seiros"},
    {987, "Student"},
    {988, "Knight of Seiros"},
    {989, "Student"},
    {990, "Student"},
    {991, "Knight of Seiros"},
    {992, "Monk"},
    {993, "Boy"},
    {994, "Monk"},
    {995, "Monk"},
    ...
    {1004, "Boy"},
    {1005, "Sothis"},
    {1006, "Knight of Seiros"},
    {1007, "Former Knight of Seiros"},
    {1010, "Grappler"},
    {1012, "Byleth"},
    {1013, "Monk"},
    {1014, "Monk"},
    ...
    {1110, "Resident"},
    {1111, "Rogue"},
    {1112, "Knight of Seiros"},
    {1113, "Priest"},
    {1114, "Thief"},
    {1115, "Umbral Beast"},
    {1116, "Knight of Seiros"},
    {1117, "Rogue"},
    {1118, "Rogue"},
    {1119, "Rogue"},
    {1120, "Soldier"},
    ...
    {1124, "Student"},
    {1125, "Student"},
    {1126, "Knight of Seiros"},
    {1127, "Knight of Seiros"},
    {1128, "Knight"},
    {1129, "Elderly Man"},
    {1130, "Fighter"},
    {1131, "Fighter"},
    ...
    {1140, "War Master"},
    {1141, "Elderly Man"},
    {1142, "Empire Commoner"},
    {1143, "Empire Commoner"},
    {1144, "Kingdom Commoner"},
    {1145, "Kingdom Commoner"},
    {1146, "Alliance Commoner"},
    {1147, "Alliance Commoner"},
    {1148, "Child"},
    {1149, "Child"},
    {1150, "Child"},
    {1151, "Child"},
...
auto getRosterCharacterClassUnlockAtIndex(size_t rosterCharacterIndex) {
    ...
    return *reinterpret_cast<ClassUnlockBitset*>(character.classUnlocks.data());
}

void setClassUnlockAtIndexOfRosterCharacterAtIndex(size_t rosterCharacterIndex, size_t classIndex, bool isUnlocked) {
    if (not gameIsRunning()) return;
    ...
    (*reinterpret_cast<ClassUnlockBitset*>(&character.classUnlocks))[classIndex] = isUnlocked;
